module github.com/sujit-baniya/frame-examples

go 1.19

require github.com/sujit-baniya/frame v0.0.5
...
require (
	...
	github.com/henrylee2cn/goutil v0.0.0-20221116101011-706757703b3f // indirect
